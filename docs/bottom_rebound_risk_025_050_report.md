...
- tradable_signals_found: 16
- signal_quality_rows: 16
- epic_like_rows: 3
...
- token_risk_anchor_events: {'MONITORING_TAG_ADDED': 21, 'SPOT_TOKEN_DELISTING_ANNOUNCED': 4}
- token_risk_missing_1h_path: []
- token_risk_absolute_bottoms_found: 24
- token_risk_tradable_signals_found: 16
